...
@section('title', 'Promoter Login')

@section('content')

<!-- Centered Container -->
<div class="flex items-center justify-center min-h-screen">
<div class="mt-7 w-96 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
  <div class="p-4 sm:p-7">
    <div class="text-center">
      <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Promoter Sign in</h1>
    </div>

    <div class="mt-5">

      <!-- Form -->
      <form action="/promoter-login" method="POST">
        {{csrf_field()}}
        <div class="grid gap-y-4">
          ...
          <div>
            ...
            <div class="relative">
              <input type="email" id="email" name="email" class="border py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="email-error">
